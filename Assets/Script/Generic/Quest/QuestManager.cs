...
public class QuestManager : Singleton<QuestManager>
{
    ...
    public bool CanStartQuest(string questId)       //특정 퀘스트를 시작할 수 있는지 검사하는 메서드
    {
        ...
        //Type questType = quest.GetType();                                                   //Quest 객체의 타임을 가져온다.
        ...
        //List<string> perrequisiteQuestIds = perrequisiteIdsValue as List<string>;           //List 로 변환하고
        //perrequisiteQuestIds = perrequisiteQuestIds ?? new List<string>();                  //null 값일 경우에는 빈 List를 사용한다.
        //?? null 병합 연산자 -> 왼쪽 값이 null 인지 확인하여 null일 경우 오른쪽으로 반환
